<div class="card">
    <div class="card-body">
        <form class="dynamicFormSubmit" method="POST" action="{{ route("diagnostic-centre.items.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="form-group col-lg-3 col-md-3 col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input required type="text" name="exp_date" value="{{ old('exp_date', '') }}" autocomplete="off" class="datepicker-here form-control digits">
                        </div>
