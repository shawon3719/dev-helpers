...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-none"></div>
            <div class="col-lg-8 col-md-8 col-sm-12">
                <div class="form-group">
                    @if(Storage::disk('public')->exists($pathology_report->report))
                        <a class="btn-sm btn-info" href="{{ route('my-reports.show') }}">
                    ...
                    @else
                        ...
                        <a class="btn-sm btn-danger" style="margin-left: 5px" href="{{ route('my-reports.pdf', $pathology_report->id) }}">
                            <i class="far fa-file-pdf"></i> PDF
                        </a>
            
                        <a class="btn-sm btn-secondary" target="_blank" style="margin-left: 5px" href="{{  route('my-reports.print', $pathology_report->id) }}">
                            ...
                            <table style="width: 100%!important">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <small style="line-height: .3;">Payment Status : Due</small> <br>
