...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('diagnosticcentre::cruds.pathology-report.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("diagnostic-centre.pathology-reports.update", $pathology_report->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" readonly type="text" name="code" id="code" value="{{ old('code', $pathology_report->code) }}" required>
                        @if($errors->has('code'))
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input readonly class="form-control {{ $errors->has('patient_id') ? 'is-invalid' : '' }}" type="text" name="patient_id" id="patient_id" value="{{ old('patient_id', $pathology_report->bill->patient->name) }}">
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input readonly class="form-control {{ $errors->has('referrer_id') ? 'is-invalid' : '' }}" type="text" name="referrer_id" id="referrer_id" value="{{ old('referrer_id', $pathology_report->bill->referrer->name) }}">
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input readonly type="text" name="reporting_date" value="{{ old('reporting_date', $pathology_report->reporting_date) }}" autocomplete="off" class="datepicker-here form-control digits">
                        </div>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <div style="margin: 10px 0!important;">
                            <input type="radio" id="create" name="report_type" value="create" {{Storage::disk('public')->exists($pathology_report->report) ? '' : 'checked'}}>
                            <label for="create" >Create</label>
                        
                            <input type="radio" id="upload" name="report_type" value="upload" {{Storage::disk('public')->exists($pathology_report->report) ? 'checked' : ''}}>
                            <label for="upload">Upload</label>
                        </div>
                        <div class="document-editor create area {{Storage::disk('public')->exists($pathology_report->report) ? 'd-none' : ''}}">
                        ...
                        <input type="hidden" id="report" name="report" value="{{Storage::disk('public')->exists($pathology_report->report) ? '' : $pathology_report->report}}">
                        <input class="form-control upload area {{Storage::disk('public')->exists($pathology_report->report) ? '' : 'd-none'}} {{ $errors->has('report') ? 'is-invalid' : '' }}" type="file" name="report" accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" value="{{ old('report', '') }}">
