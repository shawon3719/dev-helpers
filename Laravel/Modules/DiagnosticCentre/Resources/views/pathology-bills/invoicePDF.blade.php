            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 mt-5">
                <table class="" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4" style="text-align: left;"><small>Total Payable in words :  {{getAmountInWords($pathology_bills->total)}}.</small></td>
                            <td style="text-align: right; font-weight: bold">Tax</td>
                            <td style="text-align: right; font-weight:bold">{{$pathology_bills->tax}}</td>
                        </tr>
                        <tr>
                            <td colspan="4" style="text-align: left"><small>Delivery Date & Time : {{Carbon\Carbon::parse($pathology_bills->delivery_date)->format($settings['date_format'] ?? 'j F, Y').' '.Carbon\Carbon::parse($pathology_bills->delivery_time)->format('h:i A')}}</small></td>
                        ...
                        <tr>
                            <td colspan="4" rowspan="3" style="margin-top: 7px!important">
