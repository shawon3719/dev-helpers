...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("diagnostic-centre.report-templates.update", $reportTemplate->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" readonly type="text" name="code" id="code" value="{{ old('code', $reportTemplate->code) }}" required>
                        @if($errors->has('code'))
                ...
                <div class="form-group col-lg-8 col-md-8 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $reportTemplate->name) }}" required>
                        @if($errors->has('name'))
